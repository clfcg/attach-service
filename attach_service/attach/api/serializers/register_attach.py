...
class RegisterAttachSerializer(serializers.Serializer):
    ...
    areaId = serializers.CharField(required=False, allow_blank=True)
    moId = serializers.CharField(required=False, allow_blank=True)
    moCode = serializers.CharField(required=False, allow_blank=True)
    moFId = serializers.CharField(required=False, allow_blank=True)
    doctorId = serializers.CharField(required=False, allow_blank=True)
    snilsDoctor = serializers.CharField(required=False, allow_blank=True)
